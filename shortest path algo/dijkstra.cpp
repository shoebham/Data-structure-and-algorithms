...
//	
	void display_res(int s,int t,vector<int> &p)
	{
		cout<<"Shortest distance: "<<tempDist[t]-tempDist[s]<<endl;
		cout<<endl;
		cout<<"Shortest Path: \n";
		...
		{
			cout<<(char)(i+64)<<" "<<tempDist[i-1]<<endl;	
		}
//		for(auto x:p)cout<<x<<" ";
